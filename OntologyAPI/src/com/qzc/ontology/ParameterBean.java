...
public class ParameterBean {
	...
	public ParameterBean(List<String> applicationDomain, List<String> applicationArea, List<String> dataSourceType,
			List<String> dataFeature, List<String> modelBackend, List<String> modelType, List<String> modelLossFunction,
			List<String> modelOptimiser, List<String> coreLayer, List<String> functionalLayer, String accuracy,
			String precision, String recall, String f1score) {
		super();
